...
from pyrosetta import rosetta, Pose, pose_from_file, get_score_function
...
pyrosetta_flags = f'-mute all -extra_res_fa {data.params.VZN} {data.params.BPY} /home/sheffler/src/mof/mof/data/motifs/HZ4.params -preserve_crystinfo -renumber_pdb -beta_cart --dalphaball /home/sheffler/src/rosetta/master/source/external/DAlpahBall/DAlphaBall.gcc -output_virtual'
