...
pyrosetta_flags = f'-mute all -extra_res_fa {data.params.VZN} /home/sheffler/src/mof/mof/data/motifs/HZ4.params -preserve_crystinfo -renumber_pdb -beta_cart --dalphaball /home/sheffler/rosetta/master/source/external/DAlpahBall/DAlphaBall.gcc'
